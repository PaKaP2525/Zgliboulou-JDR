...
D'autre armes encore comme la montante s'utilisent à deux mains, ce qui ne permet pas l'utilisation d'un bouclier.

La plupart des armes ont un type de dégâts de base. Sauf si l'action montre clairement autre chose, le type de dégât assumé sera celui de base. Par exemple, "attaquer" avec une épée de base fait des dégâts tranchants ; mais "donner une estocade" fait des dégâts perçants.